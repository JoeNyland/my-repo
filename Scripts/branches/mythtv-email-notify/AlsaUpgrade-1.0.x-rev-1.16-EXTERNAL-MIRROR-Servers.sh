...
wget http://alsa.cybermirror.org/driver/$DRIVER.tar.bz2 && tar -xjf $DRIVER.tar.bz2 
wget http://alsa.cybermirror.org/firmware/$FIRMWARE.tar.bz2 && tar -xjf $FIRMWARE.tar.bz2 
wget http://alsa.cybermirror.org/lib/$LIB.tar.bz2 && tar -xjf $LIB.tar.bz2 
wget http://alsa.cybermirror.org/plugins/$PLUGINS.tar.bz2 && tar -xvf $PLUGINS.tar.bz2 
wget http://alsa.cybermirror.org/utils/$UTILS.tar.bz2 && tar -xjf $UTILS.tar.bz2 
wget http://alsa.cybermirror.org/tools/$TOOLS.tar.bz2 && tar -xjf $TOOLS.tar.bz2 
wget http://alsa.cybermirror.org/oss-lib/$OSS.tar.bz2 && tar -xvf $OSS.tar.bz2 
