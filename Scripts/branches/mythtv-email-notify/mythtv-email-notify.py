...
<body>
	<div id="wrap">
		<div id="header">	
			<img src="data:image/png;base64,{channelicon}" class="channel_icon" />
...
""".format(channelicon=channelicon_encoded, title=title, subtitle=subtitle, preview=preview_encoded, desc=desc, starttime=starttime_local, startdate=startdate_local, url=mythweb_url, version=version, server=servername)
