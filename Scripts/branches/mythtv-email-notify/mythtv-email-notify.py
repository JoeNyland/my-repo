...
<body>
	...
	<div id=banner-bottom>
        <a href="http://www.mythtv.org/">MythTV</a> v%s on %s
    </div>
</body>
</html>
""" %(title, subtitle, desc, title, subtitle, starttime_local, startdate_local, mythweb_url, mythtv_ver, server)
...
- Fetch MythTV version from Services API
