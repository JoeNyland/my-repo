...
<body>
	<div id="wrap">
		...
		<div id="main">
			...
			<p>
			<a href="%s">View the recording in MythWeb</a>.
			</p>
		</div>
...
""" %(title, subtitle, desc, title, subtitle, starttime_local, startdate_local, mythweb_url, version, server)
...
Email HTML:
%s""" %(str(args.chanid), args.starttime, starttime_local, startdate_local, title, subtitle, desc, mythweb_url, recording_url, recordinghtml_data, version, msg)

"""
TO DO:
- Mail.app display of footer
- Recipient address as required argument
