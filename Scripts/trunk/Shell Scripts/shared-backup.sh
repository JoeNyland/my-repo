...
rsync -vruEthm --delete --log-file=/var/log/shared-backup.log $SHARED_DIR/ $BACKUPDRIVE/Shared/ --exclude="._*" --exclude="Downloads/" --exclude=".AppleDB*" --exclude="lost+found" || exit
rsync -vruEthm --delete --log-file=/var/log/shared-backup.log $TIMEMACHINE_DIR/ $BACKUPDRIVE/TimeMachine/ --exclude="._*" --exclude=".AppleDB*" --exclude="lost+found" || exit
rsync -vruEthm --delete --log-file=/var/log/shared-backup.log $SVN/ $BACKUPDRIVE/SVN/ --exclude="._*" --exclude=".AppleDB*" || exit
rsync -vruEthm --delete --log-file=/var/log/shared-backup.log $MYTHTV/ $BACKUPDRIVE/MythTV/ --exclude="._*" --exclude=".AppleDB*" --exclude="livetv/*"|| exit
