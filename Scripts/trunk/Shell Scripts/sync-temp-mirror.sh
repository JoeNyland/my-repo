...
rsync -rtphn --del --force --progress /mnt/array/shared/ /mnt/backup1/restore/mnt/array/shared/

# Rsync /mnt/array/svn, deleting files on the mirror is they have been deleted in the live data location.
rsync -rtphn --del --force --progress /mnt/array/svn/ /mnt/backup1/restore/mnt/array/svn/