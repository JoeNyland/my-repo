...
rsync -vruEthm --progress --log-file=/var/log/shared-backup.log $SHARED_DIR/Applications $_BACKUP/ --exclude="._*" || exit
...
echo "/mnt/shared/Applications --> \\\Backups\Applications" >> /var/log/overnight-jobs.log
echo "/mnt/shared/Disc Images --> \\\Backups\Disc Images" >> /var/log/overnight-jobs.log
echo "/mnt/shared/Music --> \\\Backups\Music" >> /var/log/overnight-jobs.log
